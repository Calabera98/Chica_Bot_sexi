...
browser: ['ChicaBot-MD', 'Safari', '1.0.0'],
msgRetry,
msgRetryCache,
version,
...
sock.sendMessage(fucker.from, { contacts: { displayName: 'CHICAʙᴏᴛ-ᴍᴅ 👑', contacts: [{ vcard }] }}, {quoted: call, ephemeralExpiration: 24*60*100, disappearingMessagesInChat: 24*60*100})
await sleep(8000)
