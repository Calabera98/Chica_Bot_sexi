...
echo -e "\033[01;33mpkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install -y yarn\ngit clone https://github.com/Calabera98/Chica_Bot_sexi\ncd Chica_Bot_sexi\nyarn install\nnpm install\nnpm start\033[0m"
exit 1
else
...
menu_ayuda() {
    #printf "${v1}[${b}++${v1}]${v} ChicaBot-MD${b}: "
	read opcion
	case $opcion in
            01|1)
                am start -a android.intent.action.VIEW https://chat.whatsapp.com/-----ChicaBOT----------- &>> /dev/null
...
echo -e "\033[01;32m\033[01m🅘🅝🅘🅒🅘🅐🅝🅓🅞 Chica Bot 🚀\n\033[0m"
npm start
