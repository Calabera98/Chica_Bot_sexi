...
if (command == 'tetas') {
const resError = (await axios.get(`https://raw.githubusercontent.com/Calabera98/Chica_Bot_sexi/master/src/nsfw/tetas.json`)).data;
...
if (command == 'pechos') {
const res = (await axios.get(`https://raw.githubusercontent.com/Calabera98/Chica_Bot_sexi/master/src/nsfw/pechos.json`)).data;
